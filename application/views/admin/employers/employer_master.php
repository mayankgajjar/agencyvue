<style type="text/css">
body .empmast_list .employer-master-page table#datatable {
    width: 100% !important;
}
body .empmast_list .employer-master-page table#datatable td:last-child{width:310px;}
</style>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '.view_log', function () {
            ...
            console.log(id);
            $(".empmast_list").attr("class", "col-lg-8 empmast_list");
