...
<!--                         <input type="hidden" name="user_id" value="<?php echo (isset($user_id)) ? $user_id : ''; ?>"-->
    ...
    <!--                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'admin/brokers/brokerProfile/' . urlencode(base64_encode($broker[0]["user_id"])) . '' ?>"> <span class="btn-label"><i class="fa fa-pencil"></i></span>Edit</a>     -->
