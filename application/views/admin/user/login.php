...
<html>
    <head>
        ...
        <title>Amenitybenefits - Login</title>
        ...
        <div class="wrapper-page">
            <div class="card-box">
                ...
                <div class="panel-heading"> 
                    <h3 class="text-center"> Sign In to <strong class="text-custom">Amenitybenefits CRM</strong> </h3>
                </div> 
                <?php 
                ...
                <div class="panel-body">
                    <form class="form-horizontal m-t-20" method="post">
                        ...
                        <div class="form-group ">
                            <div class="col-xs-12">
                                <div class="checkbox checkbox-primary">
                                    <input id="checkbox-signup" type="checkbox" value="remember">
                        ...
                        <div class="form-group text-center m-t-40">
                            <div class="col-xs-12">
                                <button class="btn btn-pink btn-block text-uppercase waves-effect waves-light" type="submit" name="log_in_btn" value="login">Login</button>
                        ...
                        <div class="form-group m-t-30 m-b-0">
                            <div class="col-sm-12">
                                <a href="user/forget_password" class="text-dark"><i class="fa fa-lock m-r-5"></i> Forgot your password?</a>
                            </div>
                        </div>
                    </form> 
