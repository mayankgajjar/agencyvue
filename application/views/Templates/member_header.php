                    ...
                    <div class="menu-extras">
                        <ul class="nav navbar-nav navbar-right pull-right">
                            ...
                            <li class="dropdown navbar-c-items">
                                <a href="" class="dropdown-toggle waves-effect waves-light profile" data-toggle="dropdown" aria-expanded="true"><img src="<?php echo base_url() ?>assets/crm_image/customer_image/<?= $this->session->userdata['member_profile_img'];?>" alt="user-img" class="img-circle"><i class="fa fa-chevron-down" aria-hidden="true"></i> </a>
