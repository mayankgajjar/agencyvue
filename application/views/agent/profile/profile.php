                ...
                <div class="profile-detail card-box">
                    <div>
                        ...
                        <div class="text-left">
                            ...
                            <p class="text-muted font-13"><strong>Retension Rate :</strong> <span class="m-l-15"> <?php
                        ...
                        <div class="form-group clearfix">
                            <div class="col-lg-12">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" disabled="" value="<?= $subdomain . '.agencyvue.com'; ?>">
                                </div>
                                <div class="col-md-4">
                                    <label>Target</label>
