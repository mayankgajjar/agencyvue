                ...
                <div class="card-box lead-page">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <a class="btn btn-primary waves-effect waves-light" href="<?= base_url() . 'agent/employers/add_employer' ?>">Add Employer</a>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#datatable').dataTable({
            ...
            "sAjaxSource": "<?php echo base_url() ?>agent/employers/indexJson"
        });
