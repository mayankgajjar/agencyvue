                            ...
                            <div class="primary_div">
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-lg-12">
                                        <div class="col-lg-4 input_wrapper">
                                            ...
                                            <input type="text" id="emp_email" name="emp_email" class="form-control <?php echo (form_error('emp_email') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['employer_email'])) ? $emp_info[0]['employer_email'] : ''; ?>">
                                        </div>
                                        <div class="col-lg-4 input_wrapper">
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-lg-12">
                                        <div class="col-lg-4 input_wrapper">
                                            <label for="fname">Email Address * </label>
                                            <input type="text" id="daily_contact_email" name="daily_contact_email" class="form-control <?php echo (form_error('daily_contact_email') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['daily_contact_email'])) ? $emp_info[0]['daily_contact_email'] : ''; ?>">
                                        </div>
                                        <div class="col-lg-4 input_wrapper">
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-lg-12">
                                        <div class="col-lg-4 input_wrapper">
                                            <label for="fname">Email Address * </label>
                                            <input type="text" id="billing_contact_email" name="billing_contact_email" class="form-control <?php echo (form_error('billing_contact_email') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['billing_contact_email'])) ? $emp_info[0]['billing_contact_email'] : ''; ?>">
                                        </div>
                                        <div class="col-lg-4 input_wrapper">
                                            <label for="mname">Phone Number * </label>
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-lg-12">
                                        <div class="col-lg-4 input_wrapper">
                                            <label for="fname">Email Address * </label>
                                            <input type="text" id="technical_contact_email" name="technical_contact_email" class="form-control <?php echo (form_error('technical_contact_email') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['technical_contact_email'])) ? $emp_info[0]['technical_contact_email'] : ''; ?>">
                                        </div>
                                        <div class="col-lg-4 input_wrapper">
                                            <label for="mname">Phone Number * </label>
