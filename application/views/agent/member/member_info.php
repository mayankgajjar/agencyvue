        ...
        <div class="contact-card">
            ...
            <div class="member-info">
                ...
                <div class="m-t-20">
                    ...
                    <a href= "<?php echo base_url() . 'agent/leads/edit_leads/' . urlencode(base64_encode($result->customer_id)) ?>" class="btn btn-success waves-effect waves-light btn-sm m-l-1">Edit</a>
