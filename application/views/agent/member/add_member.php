...
<div class="wrapper">
                    ...
                    <div class="card-box">
                        <form id="frm_lead_edit" method="post" class="data-parsley-validate novalidate">
                            ...
                            <div class="primary_div">
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-lg-4 input_wrapper">
                                        ...
                                        <input type="text" id="cussecuritynumber" name="cus_security_number" class="required form-control securitynumber" autocomplete="off" value="<?php echo set_value('cus_security_number'); ?>">
                                    </div>
                                     <div class="col-lg-4 input_wrapper">
                                        <label for="customer_weight">Customer Weight * </label>
                                        <input type="text" id="customer_weight" name="customer_weight" class="required form-control customer_weight" autocomplete="off" value="<?php echo set_value('cus_weight'); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="text-center">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4 input_wrapper">
                                    <label for="mname">Phone Number  </label>
                                    <input type="text" id="spouse_phone_no" name="spouse_phone_no" class="form-control custom_phone_number_marks" autocomplete="off" value="<?php echo set_value('spouse_phone_no'); ?>">
                                </div>
                                <div class="col-lg-4 input_wrapper">
                                    <label for="fname">Date Of Birth  </label>
                                    <div class="date-picker-div">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="col-lg-4 input_wrapper">
                                    <label for="fname">Zip Code </label>
                                    <input type="text" id="zipcode" name="spouse_zipcode" class=" form-control custome_zipcode" autocomplete="off" value="<?php echo set_value('spouse_zipcode'); ?>">
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <div class="col-lg-4 input_wrapper">
                                    <label for="fname">Social Security Number </label>
                                    <input type="text" id="spouse_ssnumber" name="spouse_ssn" class=" form-control securitynumber" autocomplete="off" value="<?php echo set_value('spouse_ssn'); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group bottom-control text-center">
                                ...
                                <a class="btn btn-default waves-effect waves-light save-button" href="<?= base_url() . 'agent/members' ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i>
                                    </span>Back</a>
                            </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function save_member(form_id) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url() ?>agent/members/save_member",
    ...
    <script type="text/javascript">
        jQuery(function ($) {
            ...
            $("#cuszip").mask("99999");
            $("#cussecuritynumber").mask("999-99-9999");
        });
    </script>
