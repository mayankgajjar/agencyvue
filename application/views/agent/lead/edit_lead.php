                            ...
                            <div class="primary_div">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-lg-4 input_wrapper">
                                        ...
                                        <input type="text" id="cussecuritynumber" name="cus_security_number" class="form-control securitynumber" autocomplete="off" value="<?php echo (isset($lead_info['customer_social_security_number'])) ? $lead_info['customer_social_security_number'] : ''; ?>" >
                                    </div>
                                    <div class="col-lg-4 input_wrapper">
        ...
        $(document).ready(function () {
            ...
            function save_lead(form_id) {
                $.ajax({
                    ...
                    success: function (data) {
                        window.location.href = "<?php echo base_url() ?>agent/leads";
                        //console.log(data);
