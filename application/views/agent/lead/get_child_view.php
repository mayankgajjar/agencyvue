    ...
    <div class="child_div old-child">
        ...
        <div class="form-group clearfix">
                ...
                <div class="col-lg-4 input_wrapper">
                    ...
                    <div class="date-picker-div">
                        ...
                        <input class="form-control  dtpicker" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="form[<?php echo $key; ?>][customer_child_dob]" type="text"
        ...
        <div class="form-group clearfix">
                ...
                <div class="col-lg-4 input_wrapper">
                    ...
                    <input type="text" name="form[<?php echo $key; ?>][customer_child_social_security_number]" class=" form-control child_social_security_number" autocomplete="off" value="<?php echo $add_child_block['customer_child_social_security_number'] ?>" placeholder="XXX - XX - XXXX">
                </div>
