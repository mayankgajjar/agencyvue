...
class Broker extends CI_Model {
    ...
    public function get_all_approved_brokers($sLimit, $sWhere = "", $sOrder) {
        ...
        $options = array(
            'fields' => array(
                'b.parent_id,b.first_name,b.last_name,b.personal_city,b.personal_state,b.user_id,u.email,u.display_name,u.created_date,u1.display_name as parent_name,state.state as state_name'
            ),
            'JOIN' => array(
                array(
                    'table' => 'crm_user_tbl u',
    ...
    public function get_agent_brokers($sLimit, $sWhere = "", $sOrder) {
        $table = 'crm_user_tbl';
        $options = array(
            'fields' => '*, crm_user_tbl.user_id as broker_user_id, CONCAT(crm_broker_personal.first_name," ",crm_broker_personal.last_name) as broker_name',
            'JOIN' => array(
                array(
                    'table' => 'crm_broker_personal',
                    'condition' => 'crm_broker_personal.user_id = crm_user_tbl.user_id',
