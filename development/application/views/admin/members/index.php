            ...
            <div class="col-lg-12 lead_list">
                <div class="card-box lead-page">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <!--<a class="btn btn-primary waves-effect waves-light" href="<?= base_url() . 'admin/members/add_member' ?>">Add Members</a>-->
                        </div>
                        <div class="col-sm-4">
                     ...
                     <div class="row">
                        <div class="col-sm-6">
                            <form role="form">
                                <div class="form-group contact-search m-b-30">
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'admin/settings/Bluk_Member_Upload' ?>">Bulk Client Upload</a>
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'admin/ExportData/export_member' ?>">Export Client</a>
                                </div> <!-- form-group -->
                            </form>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" style="width:55%;">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="custom-width-modalLabel">Please Give The Reason For Inactive This Client</h4>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-danger waves-effect waves-light inactive-btn">Inactive Client</button>
                </div>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
    </div><!-- /.modal -->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#datatable').dataTable({
            ...
            "sAjaxSource": "<?php echo base_url() ?>admin/members/membersJson"
        });
        ...
        $(document).on("click", ".del_lead", function () {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        method: "POST",
                        url: '<?php echo base_url() ?>admin/members/removemember?>',
         ...
         $(document).on("click", ".active-member", function () {
            ...
            $.ajax({
                method: "POST",
                url: '<?php echo base_url() ?>admin/members/activemember',
                data: {user_id: user_id},
                success: function (data) {
                    swal("success", data, "success");
                    var $lmTable = $("#datatable").dataTable({bRetrieve: true});
            ...
            $('#frm-save-password').submit(function(e) { 
                ...
                if ( $(this).parsley().isValid() ) {
                    ...
                    $('.loader-select-city').show();
                        $.ajax({
                        method: "POST",
                        url: '<?php echo base_url() ?>admin/members/change_password_by_admin',
        ...
        $(document).on("click", ".inactive-btn", function () {
            ...
            if (selectReason == "") {
                ...
                $.ajax({
                    method: "POST",
                    url: '<?php echo base_url() ?>admin/members/inactivemember',
                    data: {user_id: user_id, reason : selectReason},
                    success: function (data) {
                        $('#custom-width-modal').modal('hide');
                        if(data = 'Member Successfully Active'){
                            swal("success", data, "success");
                        } else {
                            swal("error", data, "error");
                        }
        ...
        $(document).on('change', '#agent-selector', function () {
            ...
            $('#datatable').dataTable({
                ...
                "sAjaxSource": "<?php base_url() ?>members/membersJson?agent_id=" + agent_id
            });
        });
