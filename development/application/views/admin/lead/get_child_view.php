        ...
        <div class="form-group clearfix">
            ...
            <div class="col-lg-4 input_wrapper">
                ...
                <div class="date-picker-div">
                    <input class="form-control dtpicker" placeholder="mm/dd/yyyy" id="datepicker-autoclose" name="form[<?php echo $key; ?>][customer_child_dob]" type="text" value="<?php echo $add_child_block['customer_child_dob'] ?>">
