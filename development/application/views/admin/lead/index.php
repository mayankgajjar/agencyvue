                ...
                <div class="card-box lead-page">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control input-sm agent-fliter" id="agent-selector" name="agent-fliter">
                                ...
                                foreach ($brokers as $broker):
                                    ?>
                                    <option value="<?= $broker['display_name'] ?>"><?= $broker['display_name'] ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <form role="form">
                                <div class="form-group contact-search m-b-30">
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'admin/settings/blukleadupload' ?>">Bulk Lead Upload</a>
    ...
    $(document).ready(function () {
        ...
        $("#add_lead").click(function (e) {
            ...
            if(error == 0){
                $.ajax({
                    ...
                    data: {first: firstname, last: lastname, email1: email, con: contact},
        ...
        $(document).on('change', '#agent-selector', function () {
            ...
            $('#datatable').dataTable({
                ...
                "sAjaxSource": "<?php base_url() ?>leads/indexJson?agent_id=" + agent_id
            });
        });
    });
