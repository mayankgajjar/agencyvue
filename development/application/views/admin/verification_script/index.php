        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Manage Verification Script</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-lg-12 lead_list">
                <div class="card-box lead-page">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <a class="btn btn-default waves-effect waves-light" href="<?= base_url() . 'admin/settings/add_verification_script' ?>">Add Verification Script</a>
                        </div>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
      ...
      $('#datatable').dataTable({
          ...
          "sAjaxSource": "<?php echo base_url() ?>admin/settings/VerificationJson"
      });
