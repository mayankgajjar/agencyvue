        ...
        <div class="contact-card">
            ...
            <div class="member-info">
                ...
                <div class="m-t-20">
                    ...
                    <a href="<?php echo base_url() . 'admin/Brokers/brokerEdit?user_id=' . urlencode(base64_encode($result->user_id)) ?>" class="btn btn-success waves-effect waves-light btn-sm m-l-3">Edit</a>
