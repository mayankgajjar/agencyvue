                        ...
                        <form id="frm_lead_edit" method="post" class="data-parsley-validate novalidate">
                            ...
                            <div class="primary_div">
                                ...
                                <div class="form-group bottom-control text-center">
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'admin/agencies/edit?user_id=' . urlencode(base64_encode($details["user_id"])) . '' ?>"> <span class="btn-label"><i class="fa fa-pencil"></i></span>Edit</a>
                                    <a class="btn btn-default waves-effect waves-light" href="<?= base_url() . 'admin/agencies/manage'?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i>
                                        </span>Back</a>
                                </div>
                        </form>
                    </div>
