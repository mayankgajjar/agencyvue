...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card-box">
                    <h4 class="text-dark header-title m-t-0 m-b-30">Clients Target </h4>
                    <div class="widget-chart text-center">
                        ...
                        <h5 class="text-muted m-t-20">Total Register Clients Today</h5>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card-box">
                    <h4 class="m-t-0 header-title"><b>Recent Clients</b></h4>
