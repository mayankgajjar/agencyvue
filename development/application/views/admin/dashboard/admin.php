            ...
            <div class="col-md-12">
                <div class="col-lg-3">
                    <div class="widget-bg-color-icon card-box fadeInDown animated">
                        ...
                        <div class="text-right">
                            <h3 class="text-dark"><b class="counter"><?php echo $approvedBroker ?> </b></h3>
                ...
                <div class="col-lg-3">
                    <div class="widget-bg-color-icon card-box">
                        ...
                        <div class="text-right">
                            <h3 class="text-dark"><b class="counter"><?php echo $employer ?></b></h3>
                            <p class="text-muted">Employer Approved </p>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                </div>
