            ...
            <div class="col-lg-12 lead_list">
                <div class="card-box lead-page">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <a class="btn btn-primary waves-effect waves-light" href="<?= base_url() . 'admin/ManageAgents/add_agent' ?>">Add Agent</a>
                        </div>
                    </div>
...
$(document).ready(function () {
    ...
    $('#datatable').dataTable({
        ...
        "sAjaxSource": "<?php echo base_url('admin/ManageAgents/agentbrokesJson'); ?>"
    });
