                           ...
                           <hr>
                            ...
                            <ul class="list-inline status-list m-t-20">
                                ...
                                <div class="text-left">
                                    ...
                                    <p class="text-muted font-13"><strong>Children : </strong><span class="m-l-15"></span></p>
                        ...
                        <form id="frm_lead_edit" method="post" enctype="multipart/form-data">
                            ...
                            <div class="primary_div">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <?php if (isset($lead_info['customer_verification'])) { ?>

                                        <div class="col-lg-4 input_wrapper m-t-20">

                                            <audio controls>

                                                <source src="<?php echo site_url() . '/assets/member_verification_script/' . $lead_info['customer_verification']; ?>" type="audio/mpeg">
                            ...
                            <div class="div_child_block" style="display:none">
                                ...
                                <div class="form-group bottom-control text-center">
                                    <button type="submit" class="btn btn-success" value="save" name="save">Save</button>
 ...
 <div id="custom-add-product-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
        <div class="modal-dialog" style="width:35%;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="add_product_form" method="post" action="<?php echo site_url('agency/checkout/filter') ?>" class="data-parsley-validate novalidate">
    ...
    <script>
                            ...
                            function selectCity(state, id, name, city = null) {
...

                                {
                                    ...
                                    $.ajax({
                                        ...
                                        url: '<?php echo base_url() ?>agency/members/newcity',
                            ...
                            function onchange_city(ele) {
                                ...
                                jQuery.ajax({
                                    ...
                                    url: '<?php echo base_url() ?>agency/leads/getcity',
                            ...
                            $(document).on('click', '.product-add', function () {
                                ...
                                $.ajax({
                                    ...
                                    url: '<?php echo base_url() ?>agency/members/addproduct',
                            ...
                            $(document).on('click', '.add_new_product', function () {
                                    ...
                                    $.ajax({
                                        url: '<?php echo base_url() ?>agency/products/add_quick_product',
                                        type: 'POST',
                            ...
                            $(document).on('click', '.product-remove', function () {
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: '<?php echo base_url() ?>agency/members/removeproduct',
                                    data: {product: product_id, member: member_id},
                                    success: function (data) {
                                        swal("success", data, "success");
                            ...
                            $(document).on('click', '.product-purchase-add', function () {
                                ...
                                $.ajax({
                                    ...
                                    url: '<?php echo base_url() ?>agency/members/addmemberproduct',
                            ...
                            $(document).on('click', '.product-purchase-remove', function () {
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: '<?php echo base_url() ?>agency/members/removememberproduct',
                                    data: {product: product_id, member: member_id},
                                    success: function (data) {
                                        swal("success", data, "success");
                            ...
                            $(document).on('click', '.product-purchase-cancel', function () {
                                ...
                                $.ajax({
                                    method: "POST",
                                    url: '<?php echo base_url() ?>agency/members/cancelmemberproduct',
                                    data: {product: product_id, member: member_id},
                                    success: function (data) {
                                        swal("success", data, "success");
                                        $(".pro-purchase-add-" + key_id).attr("disabled", false);
                            ...
                            $(document).on('click', '.save-changes', function () {
                                window.location = "<?php echo base_url() ?>agency/members";
                            });
                            ...
                            function remove_old_child(obj) {
                                ...
                                if (child_id) {
                                    $.post("<?= base_url('agency/members/remove_child/') ?>" + child_id, function (data) {
                                        if (data) {
                            ...
                            function manage_payment_info() {
                                $.ajax({
                                    method: "POST",
                                    url: '<?php echo base_url() ?>agency/members/manage_payment_info',
                            ...
                            jQuery(document).on('change', '#catrgory', function(){
                                var value = $(this).val();
                                 jQuery.ajax({
                                      type: "POST",
                                        url: "<?php echo base_url('agency/members/get_product_type')?>",
