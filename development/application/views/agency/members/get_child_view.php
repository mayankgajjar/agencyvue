    ...
    <div class="child_div old-child">
        ...
        <div class="form-group clearfix">
                <div class="col-lg-4 input_wrapper">
                    ...
                    <input type="text" id="childfirstname" name="form[<?php echo $key; ?>][customer_child_first_name]" class="form-control child_data" autocomplete="off" value="<?php echo $add_child_block['customer_child_first_name'] ?>">
                </div>
                <div class="col-lg-4 input_wrapper">
                    <label for="mname">Middle Name </label>
                    <input type="text" id="childmiddlename" name="form[<?php echo $key; ?>][customer_child_middle_name]" class="form-control " autocomplete="off" value="<?php echo $add_child_block['customer_child_middle_name'] ?>">
                </div>
                <div class="col-lg-4 input_wrapper">
                    <label for="fname">Last Name </label>
                    <input type="text" id="childlastname" name="form[<?php echo $key; ?>][customer_child_last_name]" class="form-control" autocomplete="off" value="<?php echo $add_child_block['customer_child_last_name'] ?>">
                </div>
        </div>
        ...
        <div class="form-group clearfix">
                <div class="col-lg-4 input_wrapper">
                    ...
                    <input type="email" id="childemailaddress" name="form[<?php echo $key; ?>][customer_child_email]" class="form-control" autocomplete="off" value="<?php echo $add_child_block['customer_child_email'] ?>">
                </div>
                <div class="col-lg-4 input_wrapper">
                    <label for="mname">Phone Number </label>
                    <input type="text" id="childphonenumber" name="form[<?php echo $key; ?>][customer_child_phone_number]" class="form-control child_phone_number" autocomplete="off" value="<?php echo $add_child_block['customer_child_phone_number'] ?>">
                </div>
                <div class="col-lg-4 input_wrapper">
        ...
        <div class="form-group clearfix">
                <div class="col-lg-8">
                    ...
                    <input type="text" id="childliveaddress"  name="form[<?php echo $key; ?>][customer_child_address]" class="form-control" autocomplete="off" value="<?php echo $add_child_block['customer_child_address'] ?>">
                </div>
                <div class="col-lg-4 input_wrapper">
        ...
        <div class="form-group clearfix">
                ...
                <div class="col-lg-4 input_wrapper">
                    ...
                    <input type="text" id = "childzipcode" name="form[<?php echo $key; ?>][customer_child_zipcode]" class="form-control child_zipcode" autocomplete="off" value="<?php echo $add_child_block['customer_child_zipcode'] ?>">
                </div>
        </div>
        ...
        <div class="form-group clearfix">
                <div class="col-lg-4 input_wrapper">
                    ...
                    <input type="text" id="childsecuritynumber" name="form[<?php echo $key; ?>][customer_child_social_security_number]" class="form-control child_social_security_number" autocomplete="off" value="<?php echo $add_child_block['customer_child_social_security_number'] ?>" placeholder="XXX - XX - XXXX">
                </div>            
        </div>
    </div>
