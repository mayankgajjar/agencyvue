...
<div class="cart">
            ...
            <?php $orderCounter = 1; ?>
                <?php foreach ($this->session->userdata('lead_cart') as $key => $cart_data) : ?>
                    <tr class="item_list_<?= $key ?>">
                        ...
                        <td><input type="text" placeholder="Leads" value="<?php echo(isset($cart_data['filename'])) ? $cart_data['filename'] : 'Leads'; ?>" name="file_name" data-couter="<?php echo $orderCounter; ?>" class="file_name"></td>
    ...
    <a class="btn btn-info sbold" href="<?php echo site_url('agency/order/checkout') ?>" data-target="#ajax" data-toggle="modal"> Checkout </a>
...
<?php else : ?>
 <h4>Cart Is Empty, Please Go To leads Store By <a href="<?= base_url('agency/checkout/continue_shop'); ?>">Click Here</a> </h4>
<?php endif; ?>