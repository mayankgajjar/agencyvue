                    ...
                    <form method="post" id="filteForm" onsubmit="javascript:filterSubmit(event)">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_lead_type">
                                <?php $this->load->view('agency/leadstore/checkout/tabs/leadtype') ?>
                            </div>
                            <div class="tab-pane" id="tab_states">
                               <?php $this->load->view('agency/leadstore/checkout/tabs/states') ?>
                            </div>
                            <div class="tab-pane" id="tab_age">
                                <?php $this->load->view('agency/leadstore/checkout/tabs/age') ?>
                            </div>
                            <div class="tab-pane" id="tab_area">
                               <?php $this->load->view('agency/leadstore/checkout/tabs/area_code') ?>
                            </div>
                            <div class="tab-pane" id="tab_zip">
                                <?php $this->load->view('agency/leadstore/checkout/tabs/zip') ?>
                            </div>
                            <div class="tab-pane" id="tab_phone">
                                <br />
                               <?php $this->load->view('agency/leadstore/checkout/tabs/phone') ?>
                            </div>
                        </div>
                    </form>
