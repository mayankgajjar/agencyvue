        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?= base_url() . 'agency/employers' ?>">Employers</a></li>
                        ...
                        <div class="primary_div">
                            ...
                            <div class="form-group">
                                <div style="text-align: center">
                                    ...
                                    <a class="btn btn-default waves-effect waves-light" href="<?= base_url() . 'agency/employers' ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i>
                                        </span>Back</a>
                                </div>
                            </div>
                    </form>
...
<script type="text/javascript">
    $(function () {
        $("#login_email").change(function () {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>ajax/chk_email',
                type: 'POST',
                data: {email: emailid},
        ...
        $("#domain_name").change(function () {
            ...
            if (domainid != "") {
                ...
                if (!regx.test(domainid)) {
                    ...
                    $('.loader-select-city').show();
                    $.ajax({
                        url: '<?php echo base_url() ?>ajax/chk_domain',
                        type: 'POST',
