        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?= base_url() . 'agency/agents' ?>">Agents</a></li>
        ...
        <div class="row">
            <div class="col-md-4 col-lg-3">
                <div class="profile-detail card-box">
                    <div>
                        <img src="<?php echo ($broker['agent_image'] != "") ? base_url() . 'assets/crm_image/agent_profile/' . $broker['agent_image'] : base_url() . 'assets/crm_image/placeholder_agent.png' ?>" class="img-circle" alt="profile-image">
                        ...
                        <div class="row"> 
                            <div class="col-lg-12"> 
                                ...
                                <div class="form-group bottom-control text-center">
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'agency/agents/edit?user_id=' . urlencode(base64_encode($broker["user_id"])); ?>"> <span class="btn-label"><i class="fa fa-pencil"></i></span>Edit</a>     
                                    <a class="btn btn-default waves-effect waves-light" href="<?= base_url() . 'agency/agents' ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i>
                                        </span>Back</a>
                                </div>
                            </div>
                        </div>
