        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?= base_url() . 'admin/manageBrokers' ?>">Agent Section</a></li>
                    ...
                    <div class="row"> 
                        ...
                        <div class="form-group clearfix text-center" >
                            <div class="col-lg-12">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <a class="btn btn-default waves-effect waves-light" href="<?= base_url() . 'admin/brokers/manageBrokers' ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i></span>Back</a>
...
<?php endif; ?>
    ...
    function selectCity(state, id, name, city = null) {
        ...
        if (state == '')
        {
            ...
            $.ajax({
                url: '<?php echo base_url() ?>agency/agents/newCity',
                type: 'POST',
    ...
    $(function () {
        $("#login_email").change(function () {
            ...
            $('.loader-select-city').show();
            $.ajax({
                url: '<?php echo base_url() ?>admin/brokers/chk_email',
                type: 'POST',
                data: {email: emailid},
                success: function (data) {
                    $('#email_msg').html(data);
