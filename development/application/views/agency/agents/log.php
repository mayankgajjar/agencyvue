    ...
    <div class="card-box">
        <div class="contact-card">
            <a class="pull-left" href="#">
                <img class="img-circle"  src=<?php echo ($result->agent_image != "") ? base_url() . 'assets/crm_image/agent_profile/' . $result->agent_image : base_url('assets/images/users/avatar-5.jpg') ?> alt="">
            </a>
            <div class="member-info">
                ...
                <div class="m-t-20">
                    ...
                    <a href="<?php echo base_url() . 'agency/agents/edit?user_id=' . urlencode(base64_encode($result->user_id)) ?>" class="btn btn-success waves-effect waves-light btn-sm m-l-3">Edit</a>
