        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?= base_url() . 'agency/agents' ?>">Manage Agents</a></li>
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-lg-3">
                <div class="profile-detail card-box">
                    <div>
                        <img src="<?php echo ($profile['agent_image'] != "") ? base_url() . 'assets/crm_image/agent_profile/' . $profile['agent_image'] : base_url() . 'assets/crm_image/placeholder_agent.png'; ?>" class="img-circle" alt="profile-image">
                                ...
                                <div class="form-group clearfix">
                                    <div class="col-lg-12">
                                        ...
                                        <?php if ($profile['upload_void_check'] != '') { ?>
                                            <div class="col-lg-4" id="priview"><a href=<?php echo site_url() . '/assets/crm_image/broker/' . $profile["upload_void_check"]; ?> target="_blank"><i class="fa fa-file-text" id="document_priview"></i></a></div>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group clearfix">
                                <div class="col-lg-12 text-center">
                                    <div class="form-group">
                                        ...
                                        <a class="btn btn-default waves-effect waves-light" href="<?= base_url() . 'admin/brokers/manageBrokers' ?>"> <span class="btn-label"><i class="fa fa-arrow-left"></i>
                                            </span>Back</a>
                                    </div>
                                </div>
                            </div>
    ...
    $(function () {
        $("#user_state").change(function () {
            ...
            if (state == '')
            {
                ...
                $.ajax({
                    url: '<?php echo base_url() ?>agency/agents/getcity',
                    type: 'POST',
                    data: {'ustid': state},
