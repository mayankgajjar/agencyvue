<link href="http://dev.agencyvue.com/assets/plugins/jvectormap/jquery-jvectormap-2.0.2.css" rel="stylesheet" />
<link href="http://dev.agencyvue.com/assets/plugins/bootstrap-sweetalert/sweet-alert.css" rel="stylesheet" type="text/css">
...
<link href="http://dev.agencyvue.com/assets/plugins/datatables/jquery.dataTables.min.css" rel="stylesheet" type="text/css"/>
<link href="http://dev.agencyvue.com/assets/plugins/datatables/dataTables.bootstrap.min.css" rel="stylesheet" type="text/css"/>
<link href="http://dev.agencyvue.com/assets/plugins/bootstrap-datepicker/css/bootstrap-datepicker.min.css" rel="stylesheet">
<link href="http://dev.agencyvue.com/assets/css/ac-style.css" rel="stylesheet" type="text/css" />
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control required" name="catrgory" id="catrgory">
                                                    ...
                                                    <?php foreach ($product_categoies as $key => $value) :?>
                                                        <option value="<?php echo $value['product_category_name']?>" <?php echo isset($product['product_category']) && ($product['product_category'] == $value['product_category_name']) ? 'selected="selected"':''; ?>><?php echo $value['product_category_name']?></option>
                                                    <?php endforeach;?>
                                                </select>
                                            </div>
                                        </div>
