            ...
            <div class="col-lg-12">
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#custom-width-modal">Add Coverage Type</button>
                        </div>
                    </div>
    ...
    <div class="modal-dialog" style="width:35%;">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="custom-width-modalLabel">Add New Product Coverage Type</h4>
            </div>
            <div class="modal-body">
                <form id="frm_add_pcate" method="POST">
                    <div class="form-group">
                        <label for="name">Coverage Type*</label>
                        <input type="text" class="form-control" id="name" placeholder="NAME OF Coverage Type" name="name">
...
<div id="edit-custom-width-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="custom-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog" style="width:35%;">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="custom-width-modalLabel">Edit Product Coverage Type</h4>
            </div>
            <div class="modal-body">
                <form id="frm_add_pcate" method="POST">
                    <input type="hidden" id="cid" name="cateid" value="">
                    <div class="form-group">
                        <label for="name">Product Coverage Type*</label>
                        <input type="text" class="form-control" id="name-e" placeholder="NAME OF Coverage Type" name="edit_name">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#datatable').dataTable({
            ...
            "sAjaxSource": "<?php echo base_url() ?>agency/products/coverageTypeJson"
        });
    ...
    $("#add_cate").click(function (e) {
        ...
        if (error == 0) {
            $.ajax({
                type: "POST",
                url: "<?php base_url() ?>add_edit_coverageType",
    ...
    jQuery(document).on('click', '.edit_coverage_type', function () {
    ...
    $(document).on("click", ".del_cate", function () {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    method: "POST",
                    url: '<?php base_url() ?>removecoverageType',
                    data: {id: id},
                    success: function (data) {
                        swal("success", data, "success");
                        var $lmTable = $("#datatable").dataTable({bRetrieve: true});
