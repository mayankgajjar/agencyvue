...
<script type="text/javascript">
    ...
    function addFund(event){
        ...
        jQuery.ajax({
            ...
            url: '<?php echo site_url("agent/campaign/addfund") ?>',
    ...
    <div class="modal-dialog" style="width:35%;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="frm_lead1" method="post" action="<?php echo site_url('agent/checkout/filter') ?>" class="data-parsley-validate novalidate">
