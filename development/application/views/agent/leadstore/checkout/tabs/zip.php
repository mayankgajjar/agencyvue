    ...
    <div class="form-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                ...
                <button type="button" id="getzipf" class="btn btn-primary waves-effect waves-light disabled" onclick="getZip()"><?php echo 'Get Zip Codes' ?></button>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" id="getzips" class="btn btn-primary waves-effect waves-light green disabled" onclick="getZipS()"><?php echo 'Get Zip Codes' ?></button>
            </div>
        </div>
        <div class="form-group">
            <div class="text-center bold" style="color: red;"><?php echo 'OR' ?></div>
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button  type="button" id="getzipt" class="btn btn-primary waves-effect waves-light green disabled" onclick="getZipT()"><?php echo 'Get Zip Codes' ?></button>
            </div>
        </div>
    </div>
</div>
<script type="text/javascript">
    function getCounty(state_id){
        if(state_id.length > 0){
            jQuery.ajax({
                url : '<?php echo site_url('agent/checkout/getCounty') ?>',
                method : 'post',
                datType : 'json',
    ...
    function getCity(county){
        ...
        if(county.length > 0){
            jQuery.ajax({
                url : '<?php echo site_url('agent/checkout/getCity') ?>',
                method : 'post',
                datType : 'json',
    ...
    function getZip(){
        ...
        if(city_name.length > 0){
            jQuery.ajax({
                url : '<?php echo site_url('agent/checkout/getZip') ?>',
                method : 'post',
                datType : 'json',
    ...
    function getZipS(){
        ...
        if(zip.length > 0){
            jQuery.ajax({
                url : '<?php echo site_url('agent/checkout/getZipByRadius') ?>',
                method : 'post',
                datType : 'json',
    ...
    function getZipT(){
        ...
        if(filter_by_scf.length > 0){
            jQuery.ajax({
                url : '<?php echo site_url('agent/checkout/getZipByScf') ?>',
                method : 'post',
                datType : 'json',
