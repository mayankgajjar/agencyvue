...
<div class="lead-row">
    ...
    <div class="row">
        <div class="col-sm-4">
            <button type="button" class="btn btn-primary waves-effect waves-light show-area-code" id="show_area_codes" name="show_area_codes" disabled>Show Area Codes</button>
        </div>
    </div>
    ...
    <div class="row action-box" style="display: none;">
        <div class="col-sm-8 ">
            <div class="col-sm-6"><button type="button" class="btn btn-primary waves-effect waves-light" id="chk_all">Select All States</button></div>
            <div class="col-sm-6"><button type="button" class="btn btn-primary waves-effect waves-light" id="unchk_all">Unselect All States</button></div>
        </div>
    </div>

    <div class="row action-box-2" style="display: none;">
        <div class="col-sm-4">
            <button type="button" class="btn btn-primary waves-effect waves-light" id="add_selected_area_codes" name="add_selected_area_codes">Add Selected Area Codes</button>
        </div>
    </div>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '#show_area_codes', function () {
            var StateName = $('#state_list').val();
             $.ajax({
                    url : '<?php echo site_url('agent/checkout/getAreaCode') ?>',
                    method : 'post',
