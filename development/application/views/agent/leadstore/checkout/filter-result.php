...
<div class="info">
    ...
    <div class="text-center">
        <button type="button" class="btn btn-primary waves-effect waves-light" onclick="changeFilter()">
            <?php echo 'Change Filters' ?>
        </button>
    </div>
</div>
<hr />
<form action="<?= base_url('agent/checkout/add_to_cart_lead') ?>" name="lead_add_to_cart" method="post" id="lead_add_to_cart">
    ...
    <div class="quantity-box">
        ...
        <table class="table table-striped">
            ...
            <tr>
                ...
                <td style="border-bottom: none !important;"><input type="text" class="form-control" name="quantity" id="quantity" /> </td>
            </tr>
            <tr>
                <th></th>
        ...
        <div class="row">
            <div class="text-left col-md-6">
                <button type="button" id="save_filter" class="btn btn-primary waves-effect waves-light" onclick="saveFilter()">
                    <?php echo 'Save Filters' ?>
                </button>
            </div>
            <div class="text-right col-md-6">
                <input type="submit" class="btn btn-primary waves-effect waves-light" name="submit" value="Add Leads To Cart" >
            </div>
        </div>
        <br/><br/>
...
<script type="text/javascript">
    ...
    function saveFilter() {
        ...
        jQuery.ajax({
            url: '<?php echo site_url('agent/checkout/saveFilter') ?>',
            method: 'post',
            dataType: 'json',
            data: postData,
