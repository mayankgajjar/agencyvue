...
<div class="cart">
    ...
    <a class="btn btn-info sbold" href="<?php echo site_url('agent/order/checkout') ?>" data-target="#ajax" data-toggle="modal"> Checkout </a>
...
<?php else : ?>
 <h4>Cart Is Empty, Please Go To leads Store By <a href="<?= base_url('agent/checkout/continue_shop'); ?>">Click Here</a> </h4>
<?php endif; ?>