<style type="text/css">
    ...
    .fileupload-new-btn{float: right;position: absolute;right: 0;top: 0;}
    .profile-detail li.product-list{text-align: left;position: relative;
                                    width: 100%;
                                    padding-right: 50px;margin-bottom: 30px;
    }
    .fileupload-new-btn i.ion-upload{    margin-right: 0 !important;
                                         font-size: 20px;
                                         line-height: 20px;}
    .add_product_image{min-height: 50px;max-height: 100px;}

    .profile-detail .status-list .fileupload.btn.btn-purple li {left: -185%;}
    .fileupload.btn.btn-purple {overflow: visible;}
    .add-btn-custom{margin-top: 10px;}
</style>
<div class="wrapper">
    <div class="container">
                        ...
                        <div class="profile-detail card-box">
                            <div>
                                ...
                                <ul class="list-inline status-list m-t-20">
                                    <div class="text-left">
                                        <p class="text-muted font-13"><strong>Created Date : </strong> <span class="m-l-15"><?php echo $lead_member['customer_created_date']; ?></span></p>
                                        <p class="text-muted font-13"><strong>Activation Date :</strong><span class="m-l-15"></span></p>
                                        <p class="text-muted font-13"><strong>Next Billing Date :</strong> <span class="m-l-15"></span></p>
                                ...
                                <ul class="list-inline status-list m-t-20">
                                        ...
                                        <?php foreach ($member_product_array as $prodcut) : ?>
                                            ...
                                            <li class="product-list">
                                                ...
                                                if ($prodcut['is_status'] == 'W') {
                                                    $status = '<button type="button" class="btn btn-warning btn-xs"> Verification Pending </button>';
                                                } else {
                                                ...
                                                <!--                                                <div class="fileupload btn btn-purple waves-effect waves-light fileupload-new-btn">
                                                                                                    ...
                                                                                                    <input type="file" name="verification_scripts[<?php //echo $i;          ?>]" class="upload required" onchange="Validateverification(this);" multiple required>
                                                                                                </div>-->
                                            </li>
                                            <?php
                                            $i++;
                                    ...
                                    <div class="text-center">
                                        <div class="button-list">
                                            <button type="button" class="add-btn-custom btn btn-success waves-effect waves-light" data-toggle="modal" data-target="#add-product-modal">
                                    ...
                                    <div class="text-center">
                                        <div class="button-list">
                                            <a class="btn btn-success" data-toggle="modal" data-target="#payment-modal">
                                                <span class="btn-label"><i class="fa fa-plus"></i></span>Add</a>

                                            <button type="button" class="btn btn-danger waves-effect waves-light" style="display: none;">
                                                <span class="btn-label"><i class="fa fa-times"></i></span>Remove</button>
                                        </div>
                                    </div>
                                </ul>
                                <hr>
                                ...
                                <ul class="list-inline status-list m-t-20">
                                    <div class="text-left">
                                        <p class="text-muted font-13"><strong>Spouse : </strong> <span class="m-l-15"><?php
                                                if (isset($lead_member_spouse_info)) {
                                                    echo 1;
                                                } else {
                                                    echo 0;
                                                };
                                                ?></span></p>
                                        <p class="text-muted font-13"><strong>Children : </strong><span class="m-l-15"><?php echo count($add_child_block_arr); ?></span></p>
                        ...
                        <div class="card-box">
                            ...
                            <div class="primary_div">
                                <div class="form-group clearfix">
                                    <input type="hidden" name="customer_id" value="<?php echo (isset($customer_id)) ? $customer_id : ''; ?>" id="customer_id">
                                    <div class="col-lg-12">
                                ...
                                <div class="form-group clearfix">
                                    ...
                                    <div class="col-lg-4 input_wrapper">
                                        ...
                                        <input type="radio" name="gender" class="gendercheckbox" value="female"> Female
                                    </div>
                                </div>
                                <!--</div>-->
                                <div class="text-center">
                                ...
                                <div class="form-group bottom-control text-center">
                                    <button type="submit" class="btn btn-success" value="save" name="save">Next</button>
                                </div>
...
<div id="add-product-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="full-width-modalLabel" aria-hidden="true" style="display: none;">
    <div class="modal-dialog modal-full select-product-model">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></button>
                <h4 class="modal-title" id="full-width-modalLabel">Add Products In Member's Profile</h4>
            </div>
            <div class="modal-body">
                <input type="hidden" name="customerid" value=<?php echo $userid; ?>>
                <?php if (!empty($product_array)) { ?>
                    ...
                    foreach ($product_array as $key => $product):
                        ...
                        <?php if (($key) % 4 == 0 || $key == 0) { ?>
                            ...
                            <?php } ?>
                            <div class ="col-md-3 col-sm-6 col-xs-12 text-center">
                                <div class="site-image"><img class="add_product_image" src="<?php echo site_url() . '/assets/crm_image/products/' . $product['product_image']; ?>"></div>
                                ...
                                <div id="home" class="tab-pane fade in active">
                                    <div class="credit-card-details">
                                        ...
                                        <div class="proceed-button">
                                            <button type="submit">PROCEED TO SECURE PAYMENT<span><i class="fa fa-lock" aria-hidden="true"></i></span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
