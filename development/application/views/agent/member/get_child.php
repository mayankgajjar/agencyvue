<div class="child_div new-child">
    ...
    <div class="form-group clearfix">
            ...
            <div class="col-lg-4 input_wrapper">
                ...
                <input type="email" id="childemail" name="form[0][customer_child_email]" class="required form-control" autocomplete="off" value="<?php echo set_value('form[0][customer_child_email]'); ?>">
            </div>
            <div class="col-lg-4 input_wrapper">
            ...
            <div class="col-lg-4 input_wrapper">
                ...
                <div class="date-picker-div">
                    <input class="form-control dtpicker" placeholder="mm/dd/yyyy" id="required datepicker-autoclose" name="form[0][customer_child_dob]" type="text" value="<?php echo set_value('form[0][customer_child_dob]'); ?>">
    ...
    <div class="form-group clearfix">
            ...
            <div class="col-lg-4 input_wrapper">
                ...
                <select class="required form-control  child_state" name="form[0][customer_child_state]" value="" onchange="onchange_city(this)">
            ...
            <div class="col-lg-4 input_wrapper">
                ...
                <select class="required form-control  child_city" name="form[0][customer_child_city]">
