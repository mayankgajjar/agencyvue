            ...
            <div class="col-lg-12 lead_list">
                <div class="card-box lead-page">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <a class="btn btn-primary waves-effect waves-light" href="<?= base_url() . 'agent/members/add_member' ?>">Add Client</a>
                        </div>
                        <div class="col-sm-3">
                            <select class="form-control input-sm agent-fliter" id="status-selector" name="agent-fliter">
                                <option value="">Show All Clients</option>
                                <option value="Y">Show Active Clients Only</option>
                                <option value="N">Show In Active Clients Only</option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-sm-6">
                            <form role="form">
                                <div class="form-group contact-search m-b-30">
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'agent/settings/Bluk_Member_Upload' ?>">Bulk Client Upload</a>
...
//        });
        ...
        jQuery(document).on("click", "#datatable tbody tr", function (event) {
            if ($(this).find('.profile_checkbox').is(':checked')) {
                $(this).find('.profile_checkbox').prop('checked', false);
                $(this).removeClass("active");
            } else {
                $(this).find('.profile_checkbox').prop('checked', true);
