                            ...
                            <div class="form-group clearfix">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 input_wrapper">
                                        ...
                                        <input type="text" id="emp_ser_no" name="emp_ser_no" class="form-control custom_phone_number_marks <?php echo (form_error('emp_ser_no') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['employer_cus_service_number'])) ? $emp_info[0]['employer_cus_service_number'] : ''; ?>">
                                    </div>
                                    <div class="col-lg-4 input_wrapper">
                                        <label for="fname">Fax Number</label>
                                        <div class="date-picker-div">
                                            <input type="text" id="emp_fax_no" name="emp_fax_no" class="form-control cusfaxnumber" autocomplete="off"  value="<?php echo (isset($emp_info[0]['employer_fax'])) ? $emp_info[0]['employer_fax'] : ''; ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php } ?>
                                    ...
                                    <div class="col-lg-4 input_wrapper">
                                        ...
                                        <input type="text" id="emp_zipcode" name="emp_zipcode" class="form-control custome_zipcode <?php echo (form_error('emp_zipcode') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['employer_zipcode'])) ? $emp_info[0]['employer_zipcode'] : ''; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group clearfix">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 input_wrapper">
                                        ...
                                        <input type="text" id="daily_contact_contact_no" name="daily_contact_contact_no" class="form-control custom_phone_number_marks <?php echo (form_error('daily_contact_contact_no') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['daily_contact_contact_number'])) ? $emp_info[0]['daily_contact_contact_number'] : ''; ?>">
                                    </div>
                                    <div class="col-lg-4 input_wrapper">
                            ...
                            <div class="form-group clearfix">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 input_wrapper">
                                        <label for="mname">Phone Number * </label>
                                        <input type="text" id="billing_contact_contact_no" name="billing_contact_contact_no" class="form-control custom_phone_number_marks <?php echo (form_error('billing_contact_contact_no') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['billing_contact_contact_number'])) ? $emp_info[0]['billing_contact_contact_number'] : ''; ?>">
                                    </div>
                                    <div class="col-lg-4 input_wrapper">
                                        <label for="fname">Extension  </label>
                                        <div class="date-picker-div">
                            ...
                            <div class="form-group clearfix">
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-4 input_wrapper">
                                        <label for="mname">Phone Number * </label>
                                        <input type="text" id="technical_contact_contact_no" name="technical_contact_contact_no" class="form-control custom_phone_number_marks <?php echo (form_error('technical_contact_contact_no') ? 'textInputError' : '') ?>" autocomplete="off" required value="<?php echo (isset($emp_info[0]['technical_contact_contact_number'])) ? $emp_info[0]['technical_contact_contact_number'] : ''; ?>">
                                    </div>
                                    <div class="col-lg-4 input_wrapper">
                                        <label for="fname">Extension </label>
                                        <div class="date-picker-div">
