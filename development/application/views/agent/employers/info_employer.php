    ...
    <div class="card-box">
        <div class="contact-card">
            ...
            <div class="member-info">
                <h4 class="m-t-0 m-b-5 header-title"><b><?php echo $result->employer_name ?></b></h4>
                <p class="text-muted"><?php echo $result->employer_email ?></p>
                <div class="m-t-20">
                    <a href="#" class="btn btn-purple waves-effect waves-light btn-sm">Send email</a>
                    <a href=<?php echo base_url() . 'agent/employers/edit_employer/' . urlencode(base64_encode($result->user_id)) ?> class="btn btn-success waves-effect waves-light btn-sm m-l-5">Edit</a>
