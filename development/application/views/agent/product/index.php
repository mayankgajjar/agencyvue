...
<div class="wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-12">
                <h4 class="page-title"><?php echo 'Products' ?></h4>
                <ol class="breadcrumb">
            ...
            <div class="col-lg-12 lead_list">
                <div class="card-box lead-page">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <a class="btn btn-default waves-effect waves-light" href="<?= site_url('agent/products/addProduct') ?>">Add Product</a>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#datatable').dataTable({
            ...
            "sAjaxSource": "<?php echo site_url('agent/products/productJson') ?>"
        });
        ...
        $(document).on('click', '.copy_product', function () {
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo site_url('agent/products/copyProduct') ?>",
                data: {global_id: id},
        ...
        $(document).on('click', '.product_del', function () {
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo site_url('agent/products/removeProduct') ?>",
                data: {global_id: id},
                success: function (data) {
                    swal("success", data, "success");
                    var $lmTable = $("#datatable").dataTable({bRetrieve: true});
        ...
        $(document).on('click', '.product_archived', function () {
            ...
            $.ajax({
                method: "POST",
                url: "<?php echo site_url('agent/products/archivedProduct') ?>",
                data: {global_id: id},
                success: function (data) {
                    swal("success", data, "success");
                    var $lmTable = $("#datatable").dataTable({bRetrieve: true});
