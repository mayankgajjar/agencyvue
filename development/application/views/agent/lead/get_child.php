<div class="child_div new-child">
    ...
    <div class="form-group clearfix">
        ...
        <div class="col-lg-4 input_wrapper">
            ...
            <input type="text" id="mname" name="form[0][customer_child_middle_name]" class="form-control " autocomplete="off" value="">
        </div>
        <div class="col-lg-4 input_wrapper">
    ...
    <div class="form-group clearfix">
        ...
        <div class="col-lg-4 input_wrapper">
            ...
            <input type="text" id="lname" name="form[0][customer_child_address_details]" class="form-control" autocomplete="off" value="">
        </div>
