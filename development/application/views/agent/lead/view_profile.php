            ...
            <div class="row">
                <div class="col-md-4 col-lg-3">
                    <div class="profile-detail card-box">
                        <div>
                            <img src="<?php echo($lead_information[0]['customer_gender'] == 'male') ? base_url() . 'assets/crm_image/Male_Placeholder.png' : base_url() . 'assets/crm_image/Female_Placeholder.png' ?>" class="img-circle" alt="profile-image">
                            <h4 class="text-uppercase font-600"><strong><?php echo $lead_information[0]['customer_first_name'] . ' ' . $lead_information[0]['customer_last_name'] ?>
                                </strong></h4>
                        ...
                        <form id="frm_lead_edit" method="post" class="data-parsley-validate novalidate">
                            ...
                            <div class="primary_div">
                                ...
                                <div class="form-group bottom-control text-center">
                                    ...
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'agent/leads/edit_leads/'.urlencode(base64_encode($customer_id)) ?>"> <span class="btn-label"><i class="fa fa-pencil"></i></span>Edit</a>
