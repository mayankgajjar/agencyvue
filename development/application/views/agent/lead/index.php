                ...
                <div class="card-box lead-page">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <!--                            <a href="#custom-modal" class="btn btn-default btn-md waves-effect waves-light m-b-30" data-animation="fadein" data-plugin="custommodal"
                                                           data-overlaySpeed="200" data-overlayColor="#36404a"><i class="md md-add"></i> Add Lead</a>-->
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <form role="form">
                                <div class="form-group contact-search m-b-30">
                                    <a class="btn btn-success waves-effect waves-light" href="<?= base_url() . 'agent/settings/blukleadupload' ?>">Bulk Lead Upload</a>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#datatable').dataTable({
            ...
            "sAjaxSource": "<?php base_url() ?>leads/indexJson"
        });
