                        ...
                        <?php foreach ($selected_product_data as $key => $value) { ?>
                             <li>
                                <div class="details">
                                    ...
                                    <div class="descriptions"><span>Monthly Payment </span><p><?php echo $value['plan_id']; ?></p></div>
                                    <div class="btns">
                                        <button type="button" class="btn btn-danger waves-effect waves-light cancel" <?php echo isset($remove_disable) ? $remove_disable : ''; ?>  ><span class="btn-label"><i class="fa fa-times"></i></span> Cancel</button>
                                    </div>
                                </div>
