...
<html>
    ...
    if (empty($user)) {
        redirect(base_url());
    } else if ($this->session->userdata('user_info')['roll_id'] != '1') {
        redirect('/Forbidden');
    }
    ?>
    <head>
        ...
        <link href="http://dev.agencyvue.com/assets/plugins/jquery.steps/css/jquery.steps.css" rel="stylesheet" type="text/css">
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            ...
                            <li class="has-submenu <?php echo ($this->uri->segment(2) == 'members') ? 'active' : ''; ?>">
                                <a href="<?= base_url() . 'admin/members' ?>"><i class="glyphicon glyphicon-user"></i>Clients</a>
                            </li>
                            ...
                            <li class="has-submenu <?php echo ($this->uri->segment(2) == 'agencies') ? 'active' : ''; ?>">
                                <a href="#"><i class="fa fa-sitemap"></i>Agencies</a>
                                <ul class="submenu">
                                    <li><a href="<?= base_url() . 'admin/agencies/manage' ?>">Manage Agencies</a></li>
                                    <li><a href="<?= base_url() . 'admin/agencies/unapproved' ?>">Unapproved Agencies</a></li>
                                </ul>
                            </li>
...
<!--                            <li class="has-submenu <?php echo ($this->uri->segment(2) == 'billing') ? 'active' : ''; ?>">
                            ...
                            <li class="has-submenu <?php echo ($this->uri->segment(2) == 'settings') ? 'active' : ''; ?>">
                                ...
                                <ul class="submenu setting-submenu">
                                    <li class="<?php echo ($this->uri->segment(2) == 'products') ? 'active' : ''; ?>"><a href="<?= base_url() . 'admin/products' ?>"><i class="glyphicon glyphicon-tags"></i>&nbsp;Products </a></li>
                                    <li class="<?php echo ($this->uri->segment(2) == 'vendors') ? 'active' : ''; ?>"><a href="<?= base_url() . 'admin/vendors' ?>"><i class="fa fa-building-o"></i> Vendors </a></li>
                                    <li class="<?php echo ($this->uri->segment(2) == 'billing') ? 'active' : ''; ?>"><a href="#"><i class="fa fa-credit-card-alt"></i> Billing </a></li>
                                    <li class="<?php echo ($this->uri->segment(3) == 'featuredProduct') ? 'active' : ''; ?>"><a href="<?= base_url() . 'admin/settings/featuredProduct' ?>"><i class="fa fa-shopping-bag"></i> Manage Featured Product</a></li>
                                    <li class="<?php echo ($this->uri->segment(3) == 'blukleadupload') ? 'active' : ''; ?>"><a href="<?= base_url() . 'admin/settings/blukleadupload' ?>"><i class="fa fa-upload"></i> Bulk Lead Upload</a></li>
                                    <li class="<?php echo ($this->uri->segment(3) == 'blukleadupload') ? 'active' : ''; ?>"><a href="<?= base_url() . 'admin/settings/Bluk_Member_Upload' ?>"><i class="fa fa-upload"></i> Bulk Member Upload</a></li>
                                    <li class="<?php echo ($this->uri->segment(3) == 'dashboard_verification_script') ? 'active' : ''; ?>"><a href="<?= base_url() . 'admin/settings/dashboard_verification_script' ?>"><i class="fa fa-check-circle-o"></i> Verification Script</a></li>
                                    <li class="<?php echo ($this->uri->segment(3) == 'stripe') ? 'active' : ''; ?>"><a href="<?= base_url() . 'admin/settings/stripe' ?>"><i class="fa fa-cc-stripe"></i> Stripe</a></li>
                                </ul>
                            </li>
                        </ul>
                        <!-- End navigation menu        -->
