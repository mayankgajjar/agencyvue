            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if (!$user) {
                    ...
                    if ($this->session->userdata['user_info']['roll_id'] == 1) {
                        ...
                        $this->session->set_userdata('agent_primary', $agent_primary);
                        ...
                        $where = array('user_id' => $this->session->userdata['user_info']['user_id']);
                        $profile_image = get_data('crm_agencies_basic', '1', $where);
                        $agent_img = $profile_image['agency_image'];
                        $this->session->set_userdata('agency_profile_img', $agent_img);
