...
class Checkout extends CI_Controller{
    ...
    public function filter() {
        ...
        $this->template->load('agency_header', 'agency/leadstore/checkout/filter', $data);
    }
    ...
    public function filterPost() {
        ...
        if ($post && $post['is_ajax'] == true) {
            ...
            $temp_data = $this->templeadconvert_m->get_by(['agent_id' => $this->session->userdata("user_info")['user_id'], 'status' => 'true']);
            ...
            $html = $this->load->view('agency/leadstore/checkout/filter-result', $this->data, true);
            $output['success'] = true;
            //$output['data'] = $post;
            $output['html'] = $html;
        } else {
    ...
    public function cart() {
        ...
        $this->template->load('agent_header', 'agency/leadstore/checkout/cart', $this->data);
    }
  ...
  public function fetch_item($data) {
    ...
    public function ajax_cart() {
        ...
        echo $this->load->view("agency/leadstore/checkout/cart_table", $this->data, TRUE);
    }
    ...
    public function continue_shop() {
        ...
        redirect('agency/campaign/index');
    }
