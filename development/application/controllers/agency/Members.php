    ...
    public function membersJson() {
        ...
        if ($rResult) {
            ...
            foreach ($rResult as $aRow) {
                ...
                if ($aRow['is_active'] == "Y") {
                    $row[] .= '<a class="btn btn-info btn-xs table-action-btn admin-action-icon-in-data-table" href="' . base_url() . 'agency/members/view_profile?customer_id=' . urlencode(base64_encode($aRow["customer_id"])) . '"title="View Client Profile"><i class="glyphicon glyphicon-eye-open" title="View Profile"></i></a>'
                            . '<a href="' . base_url() . 'agency/members/edit_member/' . urlencode(base64_encode($aRow["customer_id"])) . '" class="btn btn-default btn-xs table-action-btn admin-action-icon-in-data-table"><i class="fa fa-pencil" title="Edit Client"></i></a>'
